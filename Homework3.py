...
class HangMan(object):
    ...
    words = '''ant animal baloon bat bear beaver camel cat clam cobra character cool
crow dream dog donkey duck eagle follow fox frog goat glove hair lion lizard llama
mirror monkey map mouse mule newt otter owl panda parrot pigeon python rabbit ram
rose raven role salmon seat shark sheep smile sloth snake spider stork sweather tiger
toad trout turkey turtle weather whale wolf walmare zebra'''.split()
